...
class No3 {
    ...
    public static class Person implements Comparable<Person> {
        ...
        public Person(String name, String vname, int plz, String starsse, int hnummer) {
            this.name =  name;
            this.vname = vname;
            this.plz = plz;
        ...
        public String toString() {
            return "Name: " + name + ", Vorname: " + vname + ", Postleitzahl: " + plz + ", Strasse " + starsse + ", Hausnummer " + hnummer;
        }
